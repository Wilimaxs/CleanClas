...
<head>
    ...
    @vite(['resources/css/user/template-started.css', 'resources/css/user/animated.css', 'resources/css/user/owl.css'])
    <!-- <link rel="stylesheet" href="assets/css/template-started.css">
    <link rel="stylesheet" href="assets/css/animated.css">
    <link rel="stylesheet" href="assets/css/owl.css"> -->
    <!-- Additional CSS Files -->
    @vite(['resources/js/user/owl-carousel.js', 'resources/js/user/animation.js', 'resources/js/user/imagesloaded.js', 'resources/js/user/custom.js', 'resources/js/user/popup.js'])
</head>
...
<body>
    ...
    <section class="modal-container">
        ...
        <div class="modal__container" id="modal-container">
            <div class="modal__content">
                ...
                <a href="{{ route('menu') }}" class="modal__button2 modal__button-width">
                Guru
                </a>
                <a href="{{ route('first') }}" class="modal__button2 modal__button-width">
                    Siswa
                </a>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="how-to-work-item show-up header-text wow fadeInLeft" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <i class="fas"> <img src="images/Signing.png" alt=""></i>
                        <h4>Proses Masuk</h4>
                ...
                <div class="col-lg-6">
                    <div class="how-to-work-item show-up header-text wow fadeInRight" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <i class="fas"> <img src="images/Agenda.png" alt=""></i>
                ...
                <div class="col-lg-6">
                    <div class="how-to-work-item show-up header-text wow fadeInLeft" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <i class="fas"> <img src="images/Approval.png" alt=""></i>
                        <h4>Persetujuan</h4>
                ...
                <div class="col-lg-6">
                    <div class="how-to-work-item show-up header-text wow fadeInRight" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <i class="fas"> <img src="images/popular.png" alt=""></i>
                ...
                <div class="col-lg-6">
                    <div class="how-to-work-item show-up header-text wow fadeInLeft" data-wow-duration="1s"
                        data-wow-delay="1s">
                        <i class="fas"> <img src="images/Leaderboard.png" alt=""></i>
                ...
                <div class="col-lg-6">
                    <div class="how-to-work-item show-up header-text wow fadeInRight" data-wow-duration="1s"
                        data-wow-delay="1s">
                        <i class="fas"> <img src="images/Report.png" alt=""></i>
                ...
                <div class="row wow fadeInUp">
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <div class="right-image wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                            <img src="images/cleanclasslogo.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4 mb-lg-0">
            ...
            <div class="row wow fadeInUp">
                <div class="col-lg-6 mx-auto">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li>
                            <a class="text-white">Wildan Tisna Surya Nugraha</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6 mx-auto">
    ...
    <!-- <script src="assets/jjs/owl-carousel.js"></script> -->
