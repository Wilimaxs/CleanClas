...
<body>
    ...
    <div class="l-form show-up header-text wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
        <div class="form">
            <img src="images/started.png" alt="" class="form__img">
            <form action="{{ route('login-guru') }}" class="form__content" method="post" id="sign-in-guru">
            @csrf
                ...
                <div class="form__div form__div-one">
                    ...
                    <div class="form__div-input">
                        ...
                        <input type="text" name="nip" class="form__input">
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form_button">
                        ...
                        <a href="#" onclick="event.preventDefault(); document.getElementById('sign-in-guru').submit();">
                        <span>sign in</span>
                        </a>
                    </div>
                </div>
